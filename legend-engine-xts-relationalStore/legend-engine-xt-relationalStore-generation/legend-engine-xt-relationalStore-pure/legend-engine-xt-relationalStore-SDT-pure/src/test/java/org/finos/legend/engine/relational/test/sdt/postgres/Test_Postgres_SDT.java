...
public class Test_Postgres_SDT extends TestSuite
{
    public static Test suite()
    {
        return SdtTestSuiteBuilder.buildSdtTestSuite(
                ...
                core_external_store_relational_sql_dialect_translation_postgres_postgresSqlDialect::Root_meta_external_store_relational_sqlDialectTranslation_postgres_postgresSdtExclusions__Pair_MANY_
        );
    }
}
