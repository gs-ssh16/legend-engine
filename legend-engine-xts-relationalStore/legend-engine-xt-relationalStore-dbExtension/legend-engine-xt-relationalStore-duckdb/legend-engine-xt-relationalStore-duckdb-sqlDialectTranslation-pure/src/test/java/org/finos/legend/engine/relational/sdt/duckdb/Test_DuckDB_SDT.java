...
public class Test_DuckDB_SDT extends TestSuite
{
    public static Test suite()
    {
        return SdtTestSuiteBuilder.buildSdtTestSuite(
                ...
                core_external_store_relational_sql_dialect_translation_duckdb_duckDBSqlDialect::Root_meta_external_store_relational_sqlDialectTranslation_duckDB_duckDBSdtExclusions__Pair_MANY_
        );
    }
}
